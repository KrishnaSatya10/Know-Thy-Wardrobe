...
def main():
    ...
    parser.add_argument(
        "--model_name", type=str, required=True, help="Specify the model name."
    )
    parser.add_argument(
        "--device", type=str, default=None, help="Specify the device (default: cpu)."
    )
    parser.add_argument(
        "--root", type=str, default="data", help="Specify the root data folder."
    )
    parser.add_argument(
        "--max_epochs", type=int, default=2, help="Specify the max number of epochs."
    )
